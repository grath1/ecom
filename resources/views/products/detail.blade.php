			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="product-details"><!--product-details-->
						<div class="col-md-6">
							<div class="text-center" class="view-product">
						...
						<div class="col-md-6">
							<form name="addtocart" id="addtocartForm" action="{{ url('add-cart') }}" method="post">{{ csrf_field() }}
								...
								<p>
									<select id="selSize" name="size" style="width: 150px;">
										...
										<option value="{{ $productDetails->id }}-{{ $sizes->size }}">{{ $sizes->size }} ({{ $sizes->stock }})</option>
										@endforeach
									</select>
								</p>
					...
					<div id="similar-product" class="carousel slide" data-ride="carousel">
					    ...
					    <div class="carousel-inner">
							<div class="item active thumbnails">
								<a href="{{ asset('images/backend_images/products/large/'.$productDetails->image) }}">
									<img class="changeImage" style="width: 100px;" class="mainImage" src="{{ asset('images/backend_images/products/small/'.$productDetails->image) }}" alt="" />
								</a>
								@foreach($productAltImages as $altimage)
									<a href="{{ asset('images/backend_images/products/large/'.$altimage->image) }}" data-standard="{{ asset('images/backend_images/products/small/'.$altimage->image) }}">
							  			<img class="changeImage" style="width: 100px; cursor: pointer;" src="{{ asset('images/backend_images/products/small/'.$altimage->image) }}" alt="">
							  		</a>
							  	@endforeach	
							</div>	
						</div>
											...
											<div class="product-image-wrapper">
												<div class="single-products">
													<div class="productinfo text-center">
														<img class="img-responsive" src="{{ asset('images/backend_images/products/small/'.$item->image) }}" alt="" />
														<h2>${{ $item->price }}</h2>
