				...
				<tbody>
					...
					@foreach($userCart as $cart)
						...
						<td class="cart_product">
							<a style="padding-right: 80px;" href=""><img style="width: 100px;" src="{{ asset('images/backend_images/products/small/'.$cart->image) }}" alt=""></a>
						</td>
						...
						<td class="cart_quantity">
							<div class="cart_quantity_button">
								...
								<label style="padding-left: 15px; padding-right: 15px;" class="cart_quantity_input" type="text" name="quantity" autocomplete="off" size="2">{{ $cart->quantity }}</label>
								@if($cart->quantity>1)
