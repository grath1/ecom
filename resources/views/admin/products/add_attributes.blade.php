...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="{{ url('/admin/dashboard')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">Products</a> <a href="{{ url('/admin/add-product')}}" class="current">Add Product Attributes</a> </div>
                ...
                <div class="widget-box">
                  ...
                  <div class="widget-content nopadding">
                    <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('/admin/add-attributes/'.$productDetails->id) }}" name="add_attributes" id="add_attributes">{{ csrf_field() }}
                      ...
                      <div class="control-group">
                        <label class="control-label">Product Base Price</label>
            ...
            <form action="{{ url('/admin/edit-attributes/'.$productDetails->id) }}" method="post">{{ csrf_field() }}
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td><strong>$</strong> <input type="text" name="price[]" value="{{ $attribute->price }}"></td>
